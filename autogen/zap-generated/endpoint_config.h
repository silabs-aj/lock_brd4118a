...
\
  ...
  { ZAP_SIMPLE_DEFAULT(0x00), 0x0000002B, 1, ZAP_TYPE(BOOLEAN), ZAP_ATTRIBUTE_MASK(WRITABLE) }, /* EnablePrivacyModeButton */  \
...
#define GENERATED_ENDPOINT_TYPES { \
  { ZAP_CLUSTER_INDEX(0), 21, 251 }, \
  { ZAP_CLUSTER_INDEX(21), 4, 185 }, \
}
...
#define FIXED_DEVICE_TYPES {{0x00000011,1},{0x00000016,1},{0x0000000A,1},{0x00000011,1}}
